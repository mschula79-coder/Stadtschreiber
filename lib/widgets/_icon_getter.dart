...
Widget getIcon(String category, double? iconsize, Color? color) {
  switch (category) {
    ...
    case "historic-defensive":
      return Iconify(
        Mdi.castle,
        size: iconsize ?? 24,
        color: color ?? Colors.black,
      );
    case "historic-demolished":
      return Iconify(
        GameIcons.demolish,
        size: iconsize ?? 24,
        color: color ?? Colors.black,
      );
    case "historic-fountain":
      return Iconify(
        Mdi.fountain,
        size: iconsize ?? 24,
        color: color ?? Colors.black,
    ...
    case "historic-monument":
      return Iconify(
        GameIcons.martyr_memorial,
        size: iconsize ?? 24,
        color: color ?? Colors.black,
      );

    case "historic-public":
      return FaIcon(
        FontAwesomeIcons.buildingColumns,
        size: iconsize ?? 24,
        color: color ?? Colors.black,
      );
    case "historic-private":
      return Iconify(
        Ic.baseline_villa,
        size: iconsize ?? 24,
        color: color ?? Colors.black,
